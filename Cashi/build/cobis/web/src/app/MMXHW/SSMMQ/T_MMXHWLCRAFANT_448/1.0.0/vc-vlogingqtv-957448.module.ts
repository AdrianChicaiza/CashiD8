...
import { VcVlogingqtv957448Component } from './vc-vlogingqtv-957448.component';


@NgModule({
  declarations: [
    VcVlogingqtv957448Component
  ],
  imports: [
    CommonModule,
    FormsModule,
    ...
    RouterModule.forChild([
      { path: '', component: VcVlogingqtv957448Component }
    ]),
    HttpClientModule,
  ...
  exports: [VcVlogingqtv957448Component],
  providers: [
    {
...
export class VcVlogingqtv957448Module { }